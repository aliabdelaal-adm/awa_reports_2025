...
<!-- لحفظ التغييرات في الموقع الفعلي، استخدم زر "تنزيل" ثم قم برفع الملف يدوياً -->
    ...
    require(['vs/editor/editor.main'], function () {
        editor = monaco.editor.create(document.getElementById('codeEditor'), {
            value: '<!-- 🎉 مرحباً بك في لوحة التحكم الشاملة - الوضع المستقل -->\n<!-- ✅ اللوحة تعمل بدون الحاجة لتشغيل خادم -->\n<!-- 📝 اختر ملفاً من القائمة للبدء في التحرير -->\n<!-- 💾 التغييرات تُحفظ تلقائياً في المتصفح -->\n<!-- ⬇️ استخدم زر "تنزيل" لحفظ الملف على جهازك -->',
            language: 'html',
            theme: 'vs-dark',
...
function saveCurrentFile() {
    ...
    showStatus('✅ تم حفظ الملف بنجاح: ' + currentFile.name + '\n💾 محفوظ في المتصفح. استخدم "تنزيل" للحفظ على الجهاز', 'success');
